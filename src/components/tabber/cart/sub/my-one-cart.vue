    ...
    <div class="one-cart-main" v-show="!delete_is">
      <div class="one-cart-box">
        <div class="switch-box">
          <van-checkbox :value="cart_info.selected" @input="onInput(cart_info.cart_is,cart_info.selected)"
                        :checked-color="$MyCommon.$main_color0"></van-checkbox>
        </div>
        <div class="card-box">
          <van-card
          ...
          <div class="card-bottom">
            ...
            <van-button size="small" @click="deleteCart">删除</van-button>
          </div>
        </div>
      </div>
    </div>
