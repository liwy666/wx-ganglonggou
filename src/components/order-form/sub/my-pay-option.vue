            ...
            preservePay(){
                ...
                this.$forceUpdate();
						...
						getPayDescAndIniPayInfo(){
							...
							this.pay_desc += this.pay_list_[this.switch_index["pay_code_key"]].
																ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
																bystages_val;
							let pay_info = {};
                ...
                pay_info.bystages_id = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_id;
                pay_info.bystages_val = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_val;
                pay_info.bystages_code = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_code;
                pay_info.bystages_fee = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_fee;
                pay_info.bystages_stage = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_stage;
                pay_info.bystages_cat_id = this.pay_list_[this.switch_index["pay_code_key"]].
                    ByStages[this.switch_index["pay_byStages_key"][this.switch_index["pay_code_key"]]].
                    bystages_cat_id;
